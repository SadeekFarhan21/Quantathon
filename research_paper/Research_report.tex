...
\author[a]{Farhan Sadeek}
\author[a]{Jayson Clark}
\author[a]{Jalen Francis}
\author[a]{Aditya Bhati}

\affil[a, b, c, d]{The Ohio State University}

% Please give the surname of the lead author for the running footer
\leadauthor{Lead author Sadeek}
